...
const Footer = () => (
  <footer className="bg-transparent mt-16">
    <div className="container border-t border-white/20 mx-auto flex flex-col gap-4 py-6">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex flex-col sm:flex-row gap-5 items-center text-sm text-white/75">
          <Link
            ...
            >
            <LogoffWordmark className="text-white/80 h-4.5"></LogoffWordmark>
          </Link>

          <Link href="/contact" className="hover:text-[#A093E8]">
            Contact us
          </Link>
        </div>

        <div className="flex items-center space-x-5 text-gray-200/80">
          <Link
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-2 text-sm text-gray-200/60">
        ...
        <p>&copy; 2025 Logoff. All rights reserved.</p>
      </div>
    </div>
  </footer>
);
